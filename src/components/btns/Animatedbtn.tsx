...
<div className="relative group cursor-pointer">
  ...
  <div
    className="absolute inset-0 border-2 border-dashed border-white rounded-lg opacity-50 group-hover:opacity-100 transition-opacity duration-300"
  ></div>

  <div
    className="absolute -top-2 -right-2 w-4 h-4 bg-white rounded-full animate-ping shadow-lg"
  ></div>
  <div
    className="absolute -bottom-2 -left-2 w-4 h-4 bg-white rounded-full animate-ping shadow-lg"
  ></div>
  <div
    className="absolute top-1/3 left-3 w-3 h-3 bg-white rounded-full animate-ping opacity-70"
  ></div>
  <div
